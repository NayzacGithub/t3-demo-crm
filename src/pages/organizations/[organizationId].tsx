                ...
                <div className="bg-white shadow-lg rounded w-fit mb-12">
                    <form className="p-4 grid grid-cols-2 gap-4 gap-x-8" onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid gap-2">
                            ...
                            <input type="text" {...register('name')} className="form-input" value={organization.data?.name} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="email" className="form-label">Email:</label>
                            <input type="text" {...register('email')} className="form-input" value={organization.data?.email} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="phone" className="form-label">Phone:</label>
                            <input type="text" {...register('phone')} className="form-input" value={organization.data?.phone} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="address" className="form-label">Address:</label>
                            <input type="text" {...register('address')} className="form-input" value={organization.data?.address} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="city" className="form-label">City:</label>
                            <input type="text" {...register('city')} className="form-input" value={organization.data?.city} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="region" className="form-label">Region:</label>
                            <input type="text" {...register('region')} className="form-input" value={organization.data?.region} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="country" className="form-label">Country:</label>
                            <input type="text" {...register('country')} className="form-input" value={organization.data?.country} />
                        </div>
                        <div className="grid gap-2">
                            <label htmlFor="postal_code" className="form-label">Postal Code:</label>
                            <input type="text" {...register('postal_code')} className="form-input" value={organization.data?.postal_code} />
                        </div>
